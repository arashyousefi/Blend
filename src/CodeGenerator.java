...
public class CodeGenerator {
	...
	public static final String FTOI_H1 = "20";
	public static final String FTOI_H2 = "24";
	public static final String FTOI_H3 = "28";
	public static final String FTOI_H4 = "32";
	...
	private void ftoi(String input, String output) {
		...
		makeCode(":=", input, "gd_f_" + FTOI_H1);
		makeCode(":=", input, "gd_f_" + FTOI_H2);
		makeCode(":=", input, "gd_f_" + FTOI_H3);

		makeCode("&", "im_i_-2147483648", "gd_i_" + FTOI_H1, "gd_i_" + FTOI_H2);
		makeCode("<<", "im_i_9", "gd_i_" + FTOI_H1);
		makeCode("<<", "im_i_1", "gd_i_" + FTOI_H3);
		makeCode(">>", "im_i_24", "gd_i_" + FTOI_H3);
		makeCode(">>", "im_i_1", "gd_i_" + FTOI_H1);
		makeCode("|", "im_i_-2147483648", "gd_i_" + FTOI_H1, "gd_i_" + FTOI_H1);
		makeCode("-", "gd_i_" + FTOI_H3, "im_i_127", "gd_i_" + FTOI_H3);
		makeCode("-", "im_i_30", "gd_i_" + FTOI_H3, "gd_i_" + FTOI_H3);
		makeCode(">>", "gd_i_" + FTOI_H3, "gd_i_" + FTOI_H1);
		makeCode("&", "im_i_1", "gd_i_" + FTOI_H1, "gd_i_" + FTOI_H4);
		makeCode(">>", "im_i_1", "gd_i_" + FTOI_H1);
		makeCode("+", "gd_i_" + FTOI_H1, "gd_i_" + FTOI_H4, "gd_i_" + FTOI_H1);
		makeCode("jz", "gd_i_" + FTOI_H2, "im_i_" + skipSign);
		makeCode("u-", "gd_i_" + FTOI_H1, "gd_i_" + FTOI_H1);
		makeCode(":=", "gd_i_" + FTOI_H1, output);
