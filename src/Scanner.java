...
/**
 * This is the template of class 'scanner'. You should place your own 'scanner class here and your
 * scanner should match this interface.
 */
public class Scanner {
	...
	public String NextToken() throws Exception {
		...
		if (token.type.equals("STRING") || token.type.equals("idINT")
				|| token.type.equals("idHEX") || token.type.equals("idREAL")
